  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '0.3.42' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 0.3.42 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
          return require('./ddk-ts.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./ddk-ts.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
...
module.exports.addSignatureToTransaction = nativeBinding.addSignatureToTransaction
module.exports.convertMnemonicToSeed = nativeBinding.convertMnemonicToSeed
module.exports.createCet = nativeBinding.createCet
module.exports.createCetAdaptorPointsFromOracleInfo = nativeBinding.createCetAdaptorPointsFromOracleInfo
...
module.exports.createCetAdaptorSigsFromPoints = nativeBinding.createCetAdaptorSigsFromPoints
...
module.exports.createExtkeyFromParentPath = nativeBinding.createExtkeyFromParentPath
module.exports.createExtkeyFromSeed = nativeBinding.createExtkeyFromSeed
...
module.exports.createXprivFromParentPath = nativeBinding.createXprivFromParentPath
module.exports.extractEcdsaSignatureFromOracleSignatures = nativeBinding.extractEcdsaSignatureFromOracleSignatures
module.exports.getCetAdaptorSignatureInputs = nativeBinding.getCetAdaptorSignatureInputs
module.exports.getCetSighash = nativeBinding.getCetSighash
module.exports.getChangeOutputAndFees = nativeBinding.getChangeOutputAndFees
module.exports.getPubkeyFromExtkey = nativeBinding.getPubkeyFromExtkey
...
module.exports.getXpubFromXpriv = nativeBinding.getXpubFromXpriv
module.exports.isDustOutput = nativeBinding.isDustOutput
module.exports.signCet = nativeBinding.signCet
module.exports.signFundTransactionInput = nativeBinding.signFundTransactionInput
module.exports.signMultiSigInput = nativeBinding.signMultiSigInput
module.exports.verifyCetAdaptorSigFromOracleInfo = nativeBinding.verifyCetAdaptorSigFromOracleInfo
module.exports.verifyCetAdaptorSigsFromOracleInfo = nativeBinding.verifyCetAdaptorSigsFromOracleInfo
